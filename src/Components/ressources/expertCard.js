                ...
                <div className="card-container">
                    <div style={{display: "flex", justifyContent:"space-between"}}>
                        ...
                        <div>
                            ...
                            <div className="skills">
                                <ul>
                                    {this.props.expert.expertiseArr.filter(itm => itm.checked).map(el => { 
                                        return <li key={el.id}>{el.value}{el.exps}</li>
                                    })}
                                </ul>
                            </div>
                        </div>
                    ...
                    <div className="footerButton">
                            ...
                            <Link to={`/print/${this.props.expert._id}`}>
                                <Button>Imprimer CV (Fr)</Button>
                            </Link>
                            <Link to={`/printE/${this.props.expert._id}`}>
                                <Button>Imprimer CV (Eng)</Button>
                            </Link>
