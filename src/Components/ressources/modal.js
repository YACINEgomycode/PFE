...
NewExpertise(i,e){
  ...
  let newexps = this.state.array.slice();
  if(newexps[i].checked = true)

  this.setState({choosenExpertise : newexps });
  console.log('dat',this.state.array)
...
<div className="modalInput">
            ...
            <div className="modalInput">
<label className='modalLabel' >société:</label>
<input className="inputItems" type="text" name="soc" value={this.state.soc} onChange={this.onChange}></input>
</div>
<div className="modalInput">
...
<div className="experiences"> {this.state.exp.map((ex)=>(<p>{ex}</p>))}</div>
              ...
              <div>
                <label style={{fontWeight:'bold'}}>Champs d'expertise:</label>
                  <div className="modalexpertise">   
                    ...
                    <ul>
                      {this.state.array.map((itm,_id)=>(
                        <li key={_id}> <input className="test" type="checkbox" onChange={this.NewExpertise.bind(this,_id)}/>
                        <label>{itm.exps}</label></li>
                      ))}
                    </ul> 
                  </div>
              </div>
